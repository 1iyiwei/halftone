...
public:
    ...
    static int WriteFIG(const vector<Tile> & tiles, const vector<P3> & palette, const vector<float> & region, const int boundary, const int color_scheme, const char *file_name);

    static int WriteFIG(const vector<L2F> & samples, const vector<Tile> & tiles, const vector<P3> & palette, const vector<float> & region, const float sample_radius, const int boundary, const int color_scheme, const char *file_name);
